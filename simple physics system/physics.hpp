...
struct Entity {
public:
	Entity(FVector2 _position, float _angle, SDL_Texture* _texture, IntVec2 size) : position(_position), angle(_angle), texture(_texture), pastPosition(_position) {
		rect = new SDL_Rect;
...
private:
	...
	static Node<RigidBody*> *entityHead;
